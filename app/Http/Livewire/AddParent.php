...
class AddParent extends Component
{
  ...
  public function edit($id)
  {
    try {
      ...
      $My_Parent = MyParents::findOrFail($id);
      // Father_INPUTS
  ...
  {
    try {
      $attach = ParentAttachment::where('parent_id', $id)->first();
      if (!empty($attach->file_name)) {
        Storage::disk('parent_attachments')->deleteDirectory($attach->parent->National_ID_Father);
      }
      MyParents::find($id)->delete();
