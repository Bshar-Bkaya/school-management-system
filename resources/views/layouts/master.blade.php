    ...
    <div class="wrapper" style="font-family: 'Cairo', sans-serif">
      ...
      <div class="content-wrapper">
        ...
        <div class="page-title">
          ...
          {{-- Show Alert  --}}
          @if(session('error'))
          <div class="alert alert-danger alert-dismissible fade show text-center" role="alert" id="session-alert">
            {{ session('error')}}
            <button id="close-alert" type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          ...
          {{--Start Handeling Validation Errors --}}
          @if ($errors->any())
          ...
          @endif
          {{--End Handeling Validation Errors --}}
