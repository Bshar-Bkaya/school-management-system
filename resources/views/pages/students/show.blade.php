            ...
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                <a class="nav-link active show" id="home-02-tab" data-toggle="tab" href="#home-02" role="tab"
                  aria-controls="home-02" aria-selected="true">{{trans('Students_trans.Student_details')}}
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="profile-02-tab" data-toggle="tab" href="#profile-02" role="tab"
                  aria-controls="profile-02" aria-selected="false">{{trans('Students_trans.Attachments')}}
                </a>
              </li>
            </ul>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade" id="profile-02" role="tabpanel" aria-labelledby="profile-02-tab">
                <div class="card card-statistics">
                  <div class="card-body">
                    <form method="post" action="{{ route('upload.attach') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      <div class="col-md-3">
                      ...
                      <tr style='text-align:center;vertical-align:middle'>
                        ...
                        <td colspan="2">
                          <a class="btn btn-outline-success btn-sm"
                            href="{{route('show.attach',[$attachment->imageable->name , $attachment->filename])}}">
                            <i class="fas fa-eye"></i>&nbsp; {{trans('Students_trans.show')}}
                          </a>

                          <a class="btn btn-outline-info btn-sm"
                            href="{{route('download.attach',[$attachment->imageable->name , $attachment->filename])}}"
                            role="button">
                            <i class="fas fa-download"></i>&nbsp; {{trans('Students_trans.Download')}}
                          </a>

                          <button type="button" class="btn btn-outline-danger btn-sm" data-toggle="modal"
                            data-target="#Delete_img{{ $attachment->id }}" title="{{ trans('Grades_trans.Delete') }}">
