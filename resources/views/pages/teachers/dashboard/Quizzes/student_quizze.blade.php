              ...
              <div class="table-responsive">
                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                  ...
                  <tbody>
                    ...
                    <div class="modal fade" id="repeat_quizze{{$degree->quizze_id}}" tabindex="-1" role="dialog"
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-info">{{ trans('Students_trans.submit') }}
                                </button>
                              </div>
                            </div>
                          </div>
